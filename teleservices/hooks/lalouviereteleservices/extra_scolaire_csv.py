...
def main():
    ...
    # Verify if there is an argument or provide help (print docstring)
    if len(sys.argv) < 2:
        print("Hey, this needs an argument to work!\n")
        print("Here is the main.__doc__:\n")
        print(main.__doc__)
        sys.exit()
